...
export default function OldApartTable({
  apartType,
  data,
  ...
  return (
    <div className="relative flex flex-col lg:flex-row h-[calc(100vh-1rem)] gap-2 bg-neutral-100 w-full transition-all duration-300">
      ...
      >
        <div className="overflow-auto rounded-md border absolute left-0 h-[calc(100vh-1.5rem)] w-full transition-all ease-in-out scrollbar-custom">
