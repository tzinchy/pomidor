    ...
    <div className="flex w-full flex-row items-center justify-start gap-1">
      <div className="flex flex-1 flex-col items-start justify-start truncate">
        ...
        <div className="line-clamp-1 text-muted-foreground text-xs">
          ...
          {(value.is_special_needs_marker || value.for_special_needs_marker) ? (<div className="inline-flex items-center rounded-full border py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground ml-1 h-4 px-1 text-xs bg-gray-100 border-gray-200">Инвалид</div>) : ''}
        </div>
      </div>
    </div>
  );
